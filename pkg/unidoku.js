...
function wasm_bindgen__convert__closures_____invoke__h3609c48714a532a2(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h3609c48714a532a2(arg0, arg1, arg2);
}

const SudokuFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sudoku_free(ptr >>> 0, 1));
...
export class Sudoku {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        SudokuFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_sudoku_free(ptr, 0);
    }
    check_solution() {
        wasm.sudoku_check_solution(this.__wbg_ptr);
    }
    constructor() {
        const ret = wasm.sudoku_new();
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_set_maxLength_1672cd373bd460dc = function(arg0, arg1) {
        arg0.maxLength = arg1;
    };
    ...
    imports.wbg.__wbindgen_cast_20d1e30a0846fe0d = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 21, function: Function { arguments: [NamedExternref("InputEvent")], shim_idx: 22, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen__closure__destroy__h0a77b1b88e11d55e, wasm_bindgen__convert__closures_____invoke__h3609c48714a532a2);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('unidoku_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
